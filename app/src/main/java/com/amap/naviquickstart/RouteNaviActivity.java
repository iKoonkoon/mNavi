...
{
    public static final String TAG = "RouteNaviActivity";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mAMapNaviView.setAMapNaviViewListener(this);//设置导航界面按钮的回调监听。

        mAMapNavi = AMapNavi.getInstance(getApplicationContext());
        mAMapNavi.addAMapNaviListener(this);//添加导航事件回调监听。
        mAMapNavi.addAMapNaviListener(mTtsManager);
        mAMapNavi.setEmulatorNaviSpeed(60);//设置模拟导航速度
        getNaviParam();
    }
...
//		mAMapNavi.destroy();
    ...
    {
        Log.e("RouteNaviActivity","onLockMap(RouteNaviActivity.java:353)"+isLock);
    }
